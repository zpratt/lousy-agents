...
- When lint diagnostics are found, the action shall post inline annotations or review comments via reviewdog at the exact file and line (annotation style depends on the configured `reporter`)

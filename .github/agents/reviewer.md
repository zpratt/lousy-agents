...
2. **Adversarial Simulation:** Look at the code not as a developer, but as an attacker. For this CLI scaffolding tool for AI-assisted development workflows, specifically check:
   ...
   - **Configuration and Template Poisoning:** Can malicious configuration files or project templates alter generated code or introduce insecure defaults?

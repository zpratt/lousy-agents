 ...
 * Delegates to the core runLint facade and handles CLI display concerns.
 */

import type { LintOutput } from "@lousy-agents/core/entities/lint.js";
import {
    createFormatter,
    type LintFormatType,
} from "@lousy-agents/core/formatters/index.js";
import { runLint } from "@lousy-agents/core/lint.js";
